...
//We are given the root node of a maximum tree: a tree where every node has a va
//lue greater than any other value in its subtree. 
//
...
// Otherwise, let A[i] be the largest element of A. Create a root node with valu
//e A[i]. 
...
public class MaximumBinaryTreeIi {
    public static void main(String[] args) {
        ...
        TreeNode node = solution.insertIntoMaxTree(TreeNode.generateFrom(new Object[]{
                5, 2, 4, null, 1
        }), 3);

         node = solution.insertIntoMaxTree(TreeNode.generateFrom(new Object[]{
                5, 2, 3, null, 1
        }), 4);
